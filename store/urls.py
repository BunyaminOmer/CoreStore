...
urlpatterns = [
    ...
    path('bildirimler/', views.notification_center_view, name='notifications'),
    path('bildirimler/<int:notification_id>/oku/', views.mark_notification_read_view, name='mark_notification_read'),
    path('bildirimler/tumunu-oku/', views.mark_all_notifications_read_view, name='mark_all_notifications_read'),
    path('destek/', views.support_center_view, name='support_center'),
    path('destek/<int:ticket_id>/', views.support_ticket_detail_view, name='support_ticket_detail'),
